...
func (p *PHPRuntime) SupportedPlatforms() []string { return []string{"windows", "darwin"} }
...
var _ ServiceController   = (*PHPRuntime)(nil) // 服务启停与状态
var _ ConfigPortsProvider = (*PHPRuntime)(nil) // 配置内端口解析
