...
var _ ServiceController   = (*OllamaRuntime)(nil) // 服务启停与状态
var _ LogProvider         = (*OllamaRuntime)(nil) // 运行日志弹窗
var _ ConfigProvider      = (*OllamaRuntime)(nil) // 配置读写
var _ ConfigPortsProvider = (*OllamaRuntime)(nil) // 配置内端口解析
