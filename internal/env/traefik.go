...
var _ ServiceController = (*TraefikRuntime)(nil)   // 服务启停与状态
var _ LogProvider = (*TraefikRuntime)(nil)         // 运行日志弹窗
var _ WebConsoleProvider = (*TraefikRuntime)(nil)  // Web 管理后台入口
var _ ConfigProvider = (*TraefikRuntime)(nil)      // 配置读写
var _ ConfigPortsProvider = (*TraefikRuntime)(nil) // 配置内端口解析
