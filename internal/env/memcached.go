...
func (m *MemcachedRuntime) SupportedPlatforms() []string { return []string{"windows", "darwin"} }
...
var _ ServiceController   = (*MemcachedRuntime)(nil) // 服务启停与状态
var _ LogProvider         = (*MemcachedRuntime)(nil) // 运行日志弹窗
var _ ConfigPortsProvider = (*MemcachedRuntime)(nil) // 配置内端口解析
