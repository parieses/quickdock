...
func (r *RabbitMQRuntime) SupportedPlatforms() []string { return []string{"windows", "darwin"} }
...
func (r *RabbitMQRuntime) ExeFor(version string) string {
	...
	return filepath.Join(r.versionDir(version), "sbin", "rabbitmqctl")
}
...
func (r *RabbitMQRuntime) serverBat(version string) string {
	...
	return filepath.Join(r.versionDir(version), "sbin", "rabbitmq-server")
}
...
var _ ServiceController   = (*RabbitMQRuntime)(nil) // 服务启停与状态
var _ LogProvider         = (*RabbitMQRuntime)(nil) // 运行日志弹窗
var _ WebConsoleProvider  = (*RabbitMQRuntime)(nil) // Web 管理后台入口
var _ ConfigPortsProvider = (*RabbitMQRuntime)(nil) // 配置内端口解析
